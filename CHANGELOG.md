...
## [0.95.0](https://github.com/tiborsimko/reana-workflow-controller/compare/0.9.4...0.95.0) (2026-09-16)


### ⚠ BREAKING CHANGES

* **manager:** Use per-session notebook tokens instead of REANA access tokens and deploy the matching OIDC server and client with the updated database schema. Use notebook images that honour NOTEBOOK_ARGS and rename user secrets that collide with reserved session variables. Workflow-engine containers no longer receive automatically mounted Kubernetes service account credentials.
...
* **python:** pin setuptools below 81 ([#670](https://github.com/tiborsimko/reana-workflow-controller/issues/670)) ([6e50d00](https://github.com/tiborsimko/reana-workflow-controller/commit/6e50d0075d83665005d0ec6b4dc944314a434046))
...
* **python:** upgrade to Flask 3.x ([#678](https://github.com/tiborsimko/reana-workflow-controller/issues/678)) ([332aa83](https://github.com/tiborsimko/reana-workflow-controller/commit/332aa839f61bd145b4a16cdb28c615aa3673e554))
...
* **python:** use pyuwsgi for pre-built wheels ([#669](https://github.com/tiborsimko/reana-workflow-controller/issues/669)) ([46200f6](https://github.com/tiborsimko/reana-workflow-controller/commit/46200f6ab5338060dcd6931b5a77cd61f0d5fb60))


### Features

* **config:** make Dask autoscaler configurable ([#604](https://github.com/tiborsimko/reana-workflow-controller/issues/604)) ([db9ac05](https://github.com/tiborsimko/reana-workflow-controller/commit/db9ac05b596f003f7f20ae5860af925cf3fc9fbf))
* **config:** propagate minimum Kubernetes job user ID env var ([#684](https://github.com/tiborsimko/reana-workflow-controller/issues/684)) ([9bfa405](https://github.com/tiborsimko/reana-workflow-controller/commit/9bfa405df1db33781d9fd9fc16e5e6590331a3a1))
...
* **docker:** externalise uWSGI controller configuration ([#683](https://github.com/tiborsimko/reana-workflow-controller/issues/683)) ([2835455](https://github.com/tiborsimko/reana-workflow-controller/commit/28354556f481ac20c33f69c9829a67ac2293e812))
...
* **list:** display interactive sessions ([#662](https://github.com/tiborsimko/reana-workflow-controller/issues/662)) ([eebd278](https://github.com/tiborsimko/reana-workflow-controller/commit/eebd2784608feb6adeaaee3ee6ef0099c5ad4b25))
* **manager:** add `user-uuid` label to runtime batch pods ([#665](https://github.com/tiborsimko/reana-workflow-controller/issues/665)) ([f8c4f79](https://github.com/tiborsimko/reana-workflow-controller/commit/f8c4f798f7566d4d9e38a119949839ba280ec5d8)), closes [#664](https://github.com/tiborsimko/reana-workflow-controller/issues/664)
* **manager:** add Kueue scheduling option for user workloads ([#658](https://github.com/tiborsimko/reana-workflow-controller/issues/658)) ([5ca4f44](https://github.com/tiborsimko/reana-workflow-controller/commit/5ca4f4408ab3c2031484dd6d38e165fb84343e33))
...
* **manager:** harden workflow run and session pods ([#694](https://github.com/tiborsimko/reana-workflow-controller/issues/694)) ([ae7f5f9](https://github.com/tiborsimko/reana-workflow-controller/commit/ae7f5f908700749178d1ea67c12ccb855f5d8e77))
...
* **manager:** isolate notebook and service account tokens ([#696](https://github.com/tiborsimko/reana-workflow-controller/issues/696)) ([07416c4](https://github.com/tiborsimko/reana-workflow-controller/commit/07416c4971853d4f87798550c9e07f102bc96826))
...
* **manager:** pass K8s requests/limits to job controller ([#643](https://github.com/tiborsimko/reana-workflow-controller/issues/643)) ([c8a6540](https://github.com/tiborsimko/reana-workflow-controller/commit/c8a6540bb2b2d9b4502d3350ff5dfe570ab38487))
* **manager:** pass K8s requests/limits to job controller ([#643](https://github.com/tiborsimko/reana-workflow-controller/issues/643)) ([71aa633](https://github.com/tiborsimko/reana-workflow-controller/commit/71aa633d83b97aa9f3a230b4845e3d27323d1bbf))
* **manager:** set runAsNonRoot on workflow-engine container ([#685](https://github.com/tiborsimko/reana-workflow-controller/issues/685)) ([11b19db](https://github.com/tiborsimko/reana-workflow-controller/commit/11b19dbc4a968aba56811bea2b041126f84691f0))
...
* **rest:** add endpoint to get workflow share status ([#552](https://github.com/tiborsimko/reana-workflow-controller/issues/552)) ([63154b5](https://github.com/tiborsimko/reana-workflow-controller/commit/63154b535ce8520303da9ccdcc873a69bb5ba617))
...
* **rest:** limit workspace file listing and add forced GC ([#657](https://github.com/tiborsimko/reana-workflow-controller/issues/657)) ([dc8bb22](https://github.com/tiborsimko/reana-workflow-controller/commit/dc8bb2220e91f85ff4bebe7bc1fc30863f56c7ce)), closes [#644](https://github.com/tiborsimko/reana-workflow-controller/issues/644)
...
* **validation:** sandbox workflow specification loading ([#693](https://github.com/tiborsimko/reana-workflow-controller/issues/693)) ([9ca3258](https://github.com/tiborsimko/reana-workflow-controller/commit/9ca3258e644cdfaddabef3f79cdad6324375456d))
...
* **config:** default OpenSearch user/password to empty ([#688](https://github.com/tiborsimko/reana-workflow-controller/issues/688)) ([f6343b6](https://github.com/tiborsimko/reana-workflow-controller/commit/f6343b68c178d03039c3c838af6207431c99b890))
* **config:** harmonise and align REANA host port handling ([#680](https://github.com/tiborsimko/reana-workflow-controller/issues/680)) ([5b6742d](https://github.com/tiborsimko/reana-workflow-controller/commit/5b6742deb4db1dca1c9f865396588de5bd9a6837))
...
* **config:** refuse running with an unset SECRET_KEY ([#688](https://github.com/tiborsimko/reana-workflow-controller/issues/688)) ([7b1fbd3](https://github.com/tiborsimko/reana-workflow-controller/commit/7b1fbd3c6385976745c88eefb63d412082652101))
...
* **config:** use glob for egg-info in flake8 exclude ([#650](https://github.com/tiborsimko/reana-workflow-controller/issues/650)) ([8092761](https://github.com/tiborsimko/reana-workflow-controller/commit/809276132a101ac40b8bd26f105286155f9fc45f))
* **consumer:** bypass kubernetes 36 pod log deserialiser ([#689](https://github.com/tiborsimko/reana-workflow-controller/issues/689)) ([895b55e](https://github.com/tiborsimko/reana-workflow-controller/commit/895b55e3b9abe813524e86ec026850ddc3298089))
* **dask:** catch cleanup errors on cluster creation failures ([#676](https://github.com/tiborsimko/reana-workflow-controller/issues/676)) ([abfaad7](https://github.com/tiborsimko/reana-workflow-controller/commit/abfaad7e63fa32cbb4f5297030e9b8539afe00c7))
...
* **dask:** create group-writable worker files ([#695](https://github.com/tiborsimko/reana-workflow-controller/issues/695)) ([0654955](https://github.com/tiborsimko/reana-workflow-controller/commit/065495532407579dc31eb1468c63d4b11d5324e7))
* **dask:** fix pulling from private container registries ([#677](https://github.com/tiborsimko/reana-workflow-controller/issues/677)) ([b6eafc5](https://github.com/tiborsimko/reana-workflow-controller/commit/b6eafc5177b7ca819118753318b4491f6f2ff6cd))
* **dask:** respect runtime namespace when deleting Dask clusters ([#675](https://github.com/tiborsimko/reana-workflow-controller/issues/675)) ([fb48ea3](https://github.com/tiborsimko/reana-workflow-controller/commit/fb48ea3f1b2e5d74c9d533df4579da273c5d98fb))
...
* **factory:** initialise umask during app startup ([#695](https://github.com/tiborsimko/reana-workflow-controller/issues/695)) ([d1ec042](https://github.com/tiborsimko/reana-workflow-controller/commit/d1ec042f61bc3e64c8f9f1d5223cbb64ffb0a737))
* **git:** update .gitignore to exclude modules directory ([#687](https://github.com/tiborsimko/reana-workflow-controller/issues/687)) ([c797ed0](https://github.com/tiborsimko/reana-workflow-controller/commit/c797ed0a1f67b7b315ce5eba9a54612827509ff1))
...
* **python:** replace deprecated V1Handler with V1LifecycleHandler ([#672](https://github.com/tiborsimko/reana-workflow-controller/issues/672)) ([942a313](https://github.com/tiborsimko/reana-workflow-controller/commit/942a313440dbe198b70bbbf75951d7afa620da0e))
...
* **rest:** hide HTCondor file-transfer directories ([#701](https://github.com/tiborsimko/reana-workflow-controller/issues/701)) ([4556719](https://github.com/tiborsimko/reana-workflow-controller/commit/4556719b9a306cf150afb17e7e4d7372cd663eef))
...
* **pytest:** drop pytest-reana for reana-commons[tests] ([#681](https://github.com/tiborsimko/reana-workflow-controller/issues/681)) ([99f9d86](https://github.com/tiborsimko/reana-workflow-controller/commit/99f9d86a6e1947dd8b55bd23f875d083d74f5291))
* **rest:** adapt to non-dynamic relationships ([#679](https://github.com/tiborsimko/reana-workflow-controller/issues/679)) ([9b15870](https://github.com/tiborsimko/reana-workflow-controller/commit/9b158702893d1af4747b8a5291b12a185c670273))
...
* **python:** adapt code base to the new black version ([#670](https://github.com/tiborsimko/reana-workflow-controller/issues/670)) ([e2cdbad](https://github.com/tiborsimko/reana-workflow-controller/commit/e2cdbadbe13aaeaae7b7d36fa8e1a0a1ef0e8c70))
...
* **commitlint:** consider commit body full stop as warning ([#643](https://github.com/tiborsimko/reana-workflow-controller/issues/643)) ([c8a6540](https://github.com/tiborsimko/reana-workflow-controller/commit/c8a6540bb2b2d9b4502d3350ff5dfe570ab38487))
* **commitlint:** consider commit body full stop as warning ([#643](https://github.com/tiborsimko/reana-workflow-controller/issues/643)) ([ee9210e](https://github.com/tiborsimko/reana-workflow-controller/commit/ee9210e4ecc834d79c721ac68dd99427ef206b78))
...
* **markdownlint:** less permissive global configuration ([#672](https://github.com/tiborsimko/reana-workflow-controller/issues/672)) ([ce03f12](https://github.com/tiborsimko/reana-workflow-controller/commit/ce03f1250b0bf77d1d501ce2dfbaadaf98d61436))
...
* **release-please:** upgrade action to v5 ([#697](https://github.com/tiborsimko/reana-workflow-controller/issues/697)) ([cec9326](https://github.com/tiborsimko/reana-workflow-controller/commit/cec9326d63ec29d885e80323b6a8b9a0038334b7))
...
* **run-tests:** add usage help and refactor options ([#672](https://github.com/tiborsimko/reana-workflow-controller/issues/672)) ([e4495aa](https://github.com/tiborsimko/reana-workflow-controller/commit/e4495aa3f71544e2e63a357a6da0db243169d606))
* **run-tests:** improve old DB container cleanup ([#678](https://github.com/tiborsimko/reana-workflow-controller/issues/678)) ([2ac3c32](https://github.com/tiborsimko/reana-workflow-controller/commit/2ac3c32633792a9ab0c4cebf54d4fb9d5e6b470a))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#647](https://github.com/tiborsimko/reana-workflow-controller/issues/647)) ([c8a6540](https://github.com/tiborsimko/reana-workflow-controller/commit/c8a6540bb2b2d9b4502d3350ff5dfe570ab38487))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#647](https://github.com/tiborsimko/reana-workflow-controller/issues/647)) ([2b004ce](https://github.com/tiborsimko/reana-workflow-controller/commit/2b004ce78456a31f398bbd9deb43b52f028f2d3a))
